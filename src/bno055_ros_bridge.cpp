...
void RosBno055::imuArduinoCb(const std_msgs::String& str)
{
    ...
    imuData.angular_velocity.x = (::atof((str.data.substr(str.data.find("avX:")+4, str.data.find("avY:")-(str.data.find("avX:")+4)).c_str()))) * (M_PI/180);
    imuData.angular_velocity.y = (::atof((str.data.substr(str.data.find("avY:")+4, str.data.find("avZ:")-(str.data.find("avY:")+4)).c_str()))) * (M_PI/180);
    imuData.angular_velocity.z = (::atof((str.data.substr(str.data.find("avZ:")+4, str.data.find("laX:")-(str.data.find("avZ:")+4)).c_str()))) * (M_PI/180);
