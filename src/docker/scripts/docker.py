...
def do():
    ...
    try:
        ...
        while not yes:
            try:
                listener.waitForTransform("/map_dock", "/tag_0", rospy.Time(0), rospy.Duration(1.0))
                (trans,rot) = listener.lookupTransform("/map_dock","/tag_0", rospy.Time(0))
        ...
        goal = MoveBaseGoal()
        goal.target_pose.header.frame_id = "map_dock"
