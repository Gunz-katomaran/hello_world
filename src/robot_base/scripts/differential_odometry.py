...
#############################################################################
    ...
    #############################################################################
        ...
        # subscriptions
        swri_rospy.Subscriber("/encoderTicks", Int32MultiArray, self.wheelCallback)
        self.odomPub = rospy.Publisher("odom", Odometry,queue_size=10)
        self.odomBroadcaster = TransformBroadcaster()

        swri_rospy.Timer(rospy.Duration(0.1), self.update) #TODO: Use rate parameter
    ...
    #############################################################################
        self.new_data = True
        enc = (msg.data[1] + msg.data[2] ) / 2 #average left front and back ticks
        ...
        enc = (msg.data[0] + msg.data[3] ) / 2 # average right front and back ticks
