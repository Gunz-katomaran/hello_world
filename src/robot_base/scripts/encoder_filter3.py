#!/usr/bin/env python
'''
A simple median filter for encoderdata from BL motor
'''
import rospy
import swri_rospy
...
pub = rospy.Publisher('encoderTicksBL', Int32, queue_size=10)
...
if __name__ == '__main__':
    rospy.init_node('encoder_filter_node3', anonymous=True)
    swri_rospy.Subscriber("/encoderTicksBLRaw", Int32, cb)
    swri_rospy.spin()
