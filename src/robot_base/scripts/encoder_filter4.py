#!/usr/bin/env python
'''
A simple median filter for encoderdata from BR motor
'''
import rospy
import swri_rospy
...
pub = rospy.Publisher('encoderTicksBR', Int32, queue_size=10)
...
if __name__ == '__main__':
    rospy.init_node('encoder_filter_node4', anonymous=True)
    swri_rospy.Subscriber("/encoderTicksBRRaw", Int32, cb)
    swri_rospy.spin()
