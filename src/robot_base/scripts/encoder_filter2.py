#!/usr/bin/env python
'''
A simple median filter for encoderdata from FL motor
'''
import rospy
import swri_rospy
...
pub = rospy.Publisher('encoderTicksFL', Int32, queue_size=10)
...
if __name__ == '__main__':
    rospy.init_node('encoder_filter_node2', anonymous=True)
    swri_rospy.Subscriber("/encoderTicksFLRaw", Int32, cb)
    swri_rospy.spin()
