...
if __name__ == '__main__':
    motor_check()
    scale = rospy.get_param('~angular_scale', 1.0)
    robot_width = robot_width / scale
    #rospy.loginfo('Parameter %s has value %s', rospy.resolve_name('~angular_scale'), scale)
    #rospy.loginfo("Width is %s " % robot_width)
