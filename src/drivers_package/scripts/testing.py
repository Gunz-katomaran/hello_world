...
class DifferentialDrive():
	def __init__(self):
		try:
			self.ser = serial.Serial('dev/ttyUSB0',baudrate=57600, parity=serial.PARITY_EVEN, bytesize=serial.EIGHTBITS,stopbits=serial.STOPBITS_ONE)
		...
		self.front_left_motor = '\x11'
		self.front_right_motor = '\x12'
