...
"""autogenerated by genpy from patrol_planner/GetPlanRequest.msg. Do not edit."""
import sys
...
class GetPlanRequest(genpy.Message):
  ...
  _type = "patrol_planner/GetPlanRequest"
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from patrol_planner/GetPlanResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetPlanResponse(genpy.Message):
  _md5sum = "de9611815b1ed22489225a55fb525c66"
  _type = "patrol_planner/GetPlanResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  __slots__ = ['pose_list','normal_goal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.pose_list is None:
        self.pose_list = []
      if self.normal_goal is None:
        self.normal_goal = False
    else:
      self.pose_list = []
      self.normal_goal = False
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_B.pack(self.normal_goal))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(_x))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(_x))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.normal_goal,) = _struct_B.unpack(str[start:end])
      self.normal_goal = bool(self.normal_goal)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class GetPlan(object):
  _type          = 'patrol_planner/GetPlan'
  _md5sum = '9d6b4f0ff14cc81eb21e6cb1c02a5f48'
