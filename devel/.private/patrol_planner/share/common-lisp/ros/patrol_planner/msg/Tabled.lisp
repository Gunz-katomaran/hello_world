...
(cl:defmethod cl:initialize-instance :after ((m <Tabled>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Tabled)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name patrol_planner-msg:<Tabled> is deprecated: use patrol_planner-msg:Tabled instead.")))
