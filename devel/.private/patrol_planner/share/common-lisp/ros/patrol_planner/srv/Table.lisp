...
(cl:defmethod cl:initialize-instance :after ((m <Table-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Table-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name patrol_planner-srv:<Table-request> is deprecated: use patrol_planner-srv:Table-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Table-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Table-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name patrol_planner-srv:<Table-response> is deprecated: use patrol_planner-srv:Table-response instead.")))
