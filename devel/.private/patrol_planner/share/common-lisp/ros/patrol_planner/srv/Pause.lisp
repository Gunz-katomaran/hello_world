...
(cl:defmethod cl:initialize-instance :after ((m <Pause-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pause-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name patrol_planner-srv:<Pause-request> is deprecated: use patrol_planner-srv:Pause-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Pause-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pause-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name patrol_planner-srv:<Pause-response> is deprecated: use patrol_planner-srv:Pause-response instead.")))
