...
(cl:defmethod cl:initialize-instance :after ((m <Park-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Park-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robo_waiter-srv:<Park-request> is deprecated: use robo_waiter-srv:Park-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Park-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Park-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robo_waiter-srv:<Park-response> is deprecated: use robo_waiter-srv:Park-response instead.")))
