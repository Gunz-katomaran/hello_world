...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_q9h.pack(_x.timestamp_ms, _x.acc_x, _x.acc_y, _x.acc_z, _x.gyro_x, _x.gyro_y, _x.gyro_z, _x.compass_x, _x.compass_y, _x.compass_z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.timestamp_ms, _x.acc_x, _x.acc_y, _x.acc_z, _x.gyro_x, _x.gyro_y, _x.gyro_z, _x.compass_x, _x.compass_y, _x.compass_z,) = _struct_q9h.unpack(str[start:end])
      return self
