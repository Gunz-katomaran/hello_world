...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2Bd.pack(_x.address_hedge, _x.address_beacon, _x.distance_m))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.address_hedge, _x.address_beacon, _x.distance_m,) = _struct_2Bd.unpack(str[start:end])
      return self
