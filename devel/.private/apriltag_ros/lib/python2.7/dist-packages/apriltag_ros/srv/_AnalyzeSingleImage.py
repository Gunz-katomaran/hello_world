...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.full_path_where_to_get_image = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.full_path_where_to_save_image = str[start:end].decode('utf-8')
      else:
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3I.pack(_x.tag_detections.header.seq, _x.tag_detections.header.stamp.secs, _x.tag_detections.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.tag_detections.header.seq, _x.tag_detections.header.stamp.secs, _x.tag_detections.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.tag_detections.header.frame_id = str[start:end].decode('utf-8')
      else:
